...
/**
 * Integration test for extra:components command
 */
class ComponentsListTest extends BaseIntegrationTest
{
    ...
    public function testComponentsListIncludesCreatedComponent()
    {
        ...
        $data = $this->executeCommandJson(['extra:components']);
