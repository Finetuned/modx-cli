...
class TranslationManager
{
    ...
    public function detectLocale(array $cliOptions = []): string
    {
        ...
        // 4. Try PHP's locale detection, then fall back to English
        $systemLocale = class_exists('\\Locale') ? \Locale::getDefault() : '';
        return !empty($systemLocale) ? $this->normalizeLocale($systemLocale) : 'en';
    }
     ...
     * @return boolean True if the locale is available.
     */
